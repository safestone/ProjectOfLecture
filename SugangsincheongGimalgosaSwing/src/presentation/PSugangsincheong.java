...
public class PSugangsincheong extends JPanel{
	...
	public PSugangsincheong() {
		...
		this.add(pLectureSelection, BorderLayout.WEST);
		pLectureSelection.setBackground(Color.GRAY);
		this.add(pMiridamgiBasket, BorderLayout.CENTER);
		pMiridamgiBasket.setBackground(Color.CYAN);
		this.add(pLectureSelection, BorderLayout.EAST);
		pLectureSelection.setBackground(Color.GREEN);
